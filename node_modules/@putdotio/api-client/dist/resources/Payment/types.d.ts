declare type PlanCode = string;
declare type PlanGroupCode = string;
declare type PlanName = string;
declare type PlanDiskSize = number;
declare type PlanExpirationDate = string;
export declare type PlanType = 'onetime' | 'subscription';
export declare type UserSubscriptionStatus = 'CANCELED' | 'PAST_DUE' | 'ACTIVE' | 'TRIALING';
