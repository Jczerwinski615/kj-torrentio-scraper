...
export declare type SaveAccountSettingsPayload = Partial<IAccountSettings> | {
    username: string;
} | {
    mail: string;
...
export declare const ACCOUNT_CLEAR_OPTION_KEYS: readonly ["files", "finished_transfers", "active_transfers", "rss_feeds", "rss_logs", "history", "trash", "friends"];
export declare type AccountInfoParams = {
    download_token?: 0 | 1;
    sharing?: 0 | 1;
    features?: 0 | 1;
    intercom?: 0 | 1;
...
export declare type AccountClearOptions = Record<typeof ACCOUNT_CLEAR_OPTION_KEYS[number], boolean>;
